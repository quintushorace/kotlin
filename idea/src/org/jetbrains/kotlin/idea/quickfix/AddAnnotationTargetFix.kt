...
class AddAnnotationTargetFix(annotationEntry: KtAnnotationEntry) : KotlinQuickFixAction<KtAnnotationEntry>(annotationEntry) {
    ...
    override fun invoke(project: Project, editor: Editor?, file: KtFile) {
        ...
        val annotationClass = annotationEntry.calleeExpression?.constructorReferenceExpression?.mainReference?.resolve() as? KtClass
        if (annotationClass?.isAnnotation() != true) return
